...
const generateAppDeclarationFile_1 = __importDefault(require("./generateAppDeclarationFile"));
const parsePheroApp_1 = require("./parsePheroApp");
const tsTestUtils_1 = require("./tsTestUtils");
function generate(prog) {
    ...
    const parsedApp = (0, parsePheroApp_1.parsePheroApp)(pheroFile, typeChecker);
    const dts = (0, generateAppDeclarationFile_1.default)(parsedApp, typeChecker);
    return dts;
}
describe("generateAppDeclarationFile", () => {
    describe("middleware", () => {
        test("should parse middleware", () => {
            const parsedApp = generate((0, tsTestUtils_1.createTestProgram)(`
