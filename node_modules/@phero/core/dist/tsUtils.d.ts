...
export declare function getChildrenOfKind<TKind extends ts.SyntaxKind>(node: ts.Node[] | ts.Node | undefined, kind: TKind): KindToNodeMappings[TKind][];
export declare function hasModifier(node: ts.Node, kind: ts.SyntaxKind): boolean;
export declare function getFirstChildOfKind<TKind extends ts.SyntaxKind>(node: ts.Node | undefined, kind: TKind): KindToNodeMappings[TKind] | undefined;
export declare function resolveSymbol(node: ts.Node | undefined, typeChecker: ts.TypeChecker): ts.Symbol | undefined;
export declare function isExternalDeclaration(declr: ts.Declaration): boolean;
export declare function isExternalSymbol(symbol: ts.Symbol): boolean;
export declare function isExternalType(type: ts.Type): boolean;
export declare function isExternalTypeNode(typeNode: ts.TypeNode): boolean;
export declare function isExternalSourceFile(sourceFile: ts.SourceFile): boolean;
export declare function getNameAsString(name: ts.PropertyName | ts.EntityName | ts.BindingName | ts.Identifier): string;
export declare function getFullyQualifiedName(typeNode: ts.NodeWithTypeArguments, typeChecker: ts.TypeChecker): {
    base: string;
    typeArgs?: string;
    full: string;
};
export declare function getFullyQualifiedNameWithBase(base: string, typeNode: ts.NodeWithTypeArguments, typeChecker: ts.TypeChecker): {
    base: string;
    typeArgs?: string;
    full: string;
};
export declare function getTypeName(typeNode: ts.TypeNode): string | undefined;
