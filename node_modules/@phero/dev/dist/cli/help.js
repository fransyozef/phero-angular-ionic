...
exports.clientHelpBuild = exports.clientHelpWatch = exports.clientHelp = exports.serverHelpBuild = exports.serverHelpExport = exports.serverHelpServe = exports.serverHelp = exports.pheroHelpInit = exports.pheroHelp = void 0;
const chalk_1 = __importDefault(require("chalk"));
exports.pheroHelp = (0, chalk_1.default) `
{dim Usage}
...
`;
exports.pheroHelpInit = (0, chalk_1.default) `
{dim Usage}
...
`;
exports.serverHelp = (0, chalk_1.default) `
{dim Usage}
...
{dim Options}
  ...
  -v, --version     Output the version number
`;
exports.serverHelpServe = (0, chalk_1.default) `
{dim Usage}
...
`;
exports.serverHelpExport = (0, chalk_1.default) `
{dim Usage}
...
`;
exports.serverHelpBuild = (0, chalk_1.default) `
{dim Usage}
...
{dim Options}
  ...
  --verbose         Output debug information
`;
exports.clientHelp = (0, chalk_1.default) `
{dim Usage}
...
{dim Options}
  ...
  -v, --version     Output the version number
`;
exports.clientHelpWatch = (0, chalk_1.default) `
{dim Usage}
...
{dim Options}
  ...
  -p, --port    4040    Specify a custom port for the client-watch-server
                        ...
                        own port.
`;
exports.clientHelpBuild = (0, chalk_1.default) `
{dim Usage}
