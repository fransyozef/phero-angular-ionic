...
describe("parseServerCommand", () => {
    function run(cmd) {
        return (0, commands_1.parseServerCommand)(cmd.split(" ").splice(1));
    }
    function err(cmd) {
        return () => run(cmd);
    }
...
describe("parseClientCommand", () => {
    function run(cmd) {
        return (0, commands_1.parseClientCommand)(cmd.split(" ").splice(1));
    }
    function err(cmd) {
        return () => run(cmd);
    }
    ...
    describe("watch", () => {
        ...
        test("cmd:   'phero-client watch http://localhost:1234 --verbose --port 4321'", () => {
            expect(run("phero-client watch http://localhost:1234 --verbose --port 4321")).toMatchSnapshot();
        });
    ...
    describe("build", () => {
        ...
        test("cmd:   'phero-client build http://localhost:1234 --verbose'", () => {
            expect(run("phero-client build http://localhost:1234 --verbose")).toMatchSnapshot();
        });
    });
});
describe("parsePheroCommand", () => {
    function run(cmd) {
        return (0, commands_1.parsePheroCommand)(cmd.split(" ").splice(1));
    }
    function err(cmd) {
        return () => run(cmd);
    }
